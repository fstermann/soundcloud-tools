...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        "Sets up Tensorflow for linking against it."
    ...
    parser.add_argument("--mode", "-m", default="python", choices=["python", "libtensorflow"])
    parser.add_argument("--platform", "-p", default="linux", choices=["linux", "macos", "windows"])
    ...
    if args.mode == "python":
        ...
        try:
            ...
            raise (
                Exception("tensorflow is not available from this interpreter.\n" "Suggestion: `pip install tensorflow`")
            ) from error
